...
public final class Config
{
	...
	public static final String HOPZONE_FILE = "./config/hopzoneReward.properties";
	...
	public static void load()
	{
		if (Server.serverMode == Server.MODE_GAMESERVER)
		{
			...
			ExProperties hz = load(HOPZONE_FILE);
			ALLOW_HOPZONE_VOTE_REWARD = hz.getProperty("AllowHopzoneVoteReward", false);
			HOPZONE_SERVER_LINK = hz.getProperty("HopzoneServerLink", "http://l2.topzone.net/lineage2/details/74078/L2World-Servers/");
			HOPZONE_VOTES_DIFFERENCE = hz.getProperty("HopzoneVotesDifference", 5);
			HOPZONE_REWARD_CHECK_TIME = hz.getProperty("HopzoneRewardCheckTime", 5);
			HOPZONE_REWARD = parseItemsList(hz.getProperty("HopzoneReward", "57,100000000;"));
			HOPZONE_DUALBOXES_ALLOWED = hz.getProperty("HopzoneDualboxesAllowed", 1);
