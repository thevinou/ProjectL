...
public class Pvp
{
	...
	/**
	 * @param warKills the _warKills to set
	 */
	...
	/**
	 * @param warKillsLegal the _warKillsLegal to set
	 */
	public void setWarKillsLegal(int warKillsLegal)
	{
		_warKillsLegal = warKillsLegal;
		onUpdate();
	}
