 ...
 * @author Masterio
 */
public class RankPvpSystemDeathStatus
{
	 ...
	 * @param killer
	 */
	public RankPvpSystemDeathStatus(L2PcInstance killer)
	{	
		if(killer == null)
			return;
	...
	private String preparePage()
	{
		...
		tb += "<table width=270 border=0 cellspacing=0 cellpadding=2 bgcolor=000000>";
			...
			tb += "<tr><td width=270 height=18 align=center><font color=ae9977>Killer Class:</font> "+RankPvpSystemUtil.getClassName(_killerClassId)+"</td></tr>";
		...
		tb += "<table border=0 cellspacing=0 cellpadding=0>";
			...
			tb += "<tr><td width=270 height=12></td></tr>";
			tb += "<tr><td width=270 align=center><button value=\"Back\" action=\"bypass -h RPS.PS\"  width="+RankPvpSystemConfig.BUTTON_W+" height="+RankPvpSystemConfig.BUTTON_H+" back=\""+RankPvpSystemConfig.BUTTON_DOWN+"\" fore=\""+RankPvpSystemConfig.BUTTON_UP+"\"></td></tr>";
		tb += "</table>";
